 ...
 *  STATIC VARIABLES
 **********************/
static void * lv_mem_pool_addr_base = NULL;
/**********************
 *      MACROS
 **********************/
 ...
 *   GLOBAL FUNCTIONS
 **********************/
void * jy_get_mem_pool_addr(void)
{
    return lv_mem_pool_addr_base;
}
...
void lv_mem_init(void)
{
    ...
    lv_mem_pool_addr_base = (void *)LV_MEM_POOL_ALLOC(LV_MEM_SIZE);
    state.tlsf = lv_tlsf_create_with_pool(lv_mem_pool_addr_base, LV_MEM_SIZE);
#else
