...
/**
 * @brief Compares the first len bytes of the block of memory pointed to by src
 *        to the first len bytes pointed to by dst.
 * @param dst Pointer to block of memory.
 * @param src Pointer to block of memory.
 * @param len Number of bytes to compare.
 * @return Negative value if dst < src, 0 if dst == src, positive value if dst > src.
 */
